...
export const generateRecommendations = (topSkills: string[]) => {
  const recommendations: Record<string, { courses: string[], jobs: string[], description: string }> = {
    'Developer': {
      description: 'You show strong technical problem-solving abilities and enjoy building solutions.',
      courses: ['Full-Stack Development', 'Data Structures & Algorithms', 'Cloud Computing'],
    ...
    'Marketer': {
      description: 'You excel at communication and understanding audience needs.',
    ...
    'Teacher': {
      description: 'You have strong communication skills and enjoy helping others learn.',
      courses: ['Educational Technology', 'Curriculum Design', 'Learning Psychology'],
      jobs: ['Training Specialist', 'Content Creator', 'Educational Consultant']
    },
    'Project Manager': {
      description: 'You show leadership qualities and enjoy organizing and coordinating.',
