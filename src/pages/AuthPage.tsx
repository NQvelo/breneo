          ...
          {!selectedRole ? (
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <Card className="cursor-pointer border-2 border-white hover:border-[#60ccff] rounded-2xl" onClick={() => handleRoleSelection('student')}>
                ...
                <Card className="cursor-pointer border-2 border-white hover:border-[#60ccff] rounded-2xl" onClick={() => handleRoleSelection('academy')}>
                  <CardContent className="p-6">
                    <div className="flex items-start space-x-4">
                      <div className="flex-shrink-0">
                        <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center">
