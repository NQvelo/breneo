...
const NotificationsPage = () => {
  ...
  const unreadCount = notifications?.filter(n => !n.is_read && n.recipient_id === user?.id).length || 0;
            ...
            <div className="space-y-4">
              {isLoading ? (
                ...
                <div className="text-center py-12 text-muted-foreground">
                  ...
                  <p className="text-sm">You'll see new notifications here when they arrive</p>
                </div>
              ) : (
