    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" className="h-8 w-8 rounded-full p-0">
          <div className="h-8 w-8 rounded-full bg-[#1BABE5] flex items-center justify-center text-white font-semibold text-sm">
    ...
    <DashboardLayout>
      <div className="py-4 md:py-6">
        ...
        {!userData.skillTestTaken && (
          <Card className="mb-4 md:mb-6 bg-gradient-to-r from-[#1BABE5]/10 to-[#1BABE5]/5 border-[#1BABE5]/20 rounded-2xl">
            <CardContent className="p-4 md:p-6">
              <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
                ...
                <Button asChild className="bg-[#1BABE5] hover:bg-[#1BABE5]/90 rounded-2xl w-full md:w-auto">
                  <Link to="/skill-test">
                    Take Skill Test
                  </Link>
                </Button>
            ...
            <CardContent className="pt-0">
              {jobsLoading || skillsLoading ? (
                <div className="space-y-4">
                  {[...Array(3)].map((_, i) => (
                    <div key={i} className="border border-gray-100 rounded-2xl p-3 md:p-4">
                ...
                <div className="text-center py-4 md:py-6">
                  ...
                  <Button variant="outline" onClick={() => window.location.reload()} className="rounded-2xl text-sm md:text-base border-gray-200">
                    Retry
                  </Button>
                </div>
                ...
                <div className="space-y-3 md:space-y-4">
                  {recommendedJobs.map(job => (
                    <div key={job.id} className="border border-gray-100 rounded-2xl p-3 md:p-4">
                      <div className="flex justify-between items-start mb-2">
                        ...
                        <div className="bg-[#1BABE5]/10 text-[#1BABE5] px-2 py-1 rounded-2xl text-xs md:text-sm font-medium ml-2 flex-shrink-0">
                          {job.match}% Match
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="text-center mt-4">
                    <Button variant="outline" asChild className="rounded-2xl w-full sm:w-auto text-sm md:text-base border-gray-200">
                ...
                <div className="text-center py-4 md:py-6">
                  ...
                  <Button asChild className="bg-[#1BABE5] hover:bg-[#1BABE5]/90 rounded-2xl w-full sm:w-auto text-sm md:text-base">
              ...
              {recommendedCourses.length > 0 ? (
                <div className="space-y-3 md:space-y-4">
                  {recommendedCourses.map(course => (
                    <div key={course.id} className="border border-gray-100 rounded-2xl p-3 md:p-4">
                      <div className="mb-2">
                      ...
                      <Button variant="outline" size="sm" className="mt-2 rounded-2xl text-xs md:text-sm border-gray-200">View Course</Button>
                    </div>
                  ))}
                  <div className="text-center mt-4">
                    <Button variant="outline" asChild className="rounded-2xl w-full sm:w-auto text-sm md:text-base border-gray-200">
        ...
        <Card className="rounded-2xl border-gray-100">
          ...
          <CardContent className="pt-0">
            ...
            <div className="mt-4 md:mt-6 text-center">
              ...
              <Button variant="outline" className="text-[#1BABE5] rounded-2xl text-sm md:text-base w-full sm:w-auto border-gray-200">Update Profile</Button>
            </div>
          </CardContent>
        </Card>
      </div>
